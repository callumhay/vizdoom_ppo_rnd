...
- Replace the LSTM with a Hopfield Network implementation based on the latest developments from [Hopfield Networks is All You Need](https://arxiv.org/abs/2008.02217) or some other RNN module with better long-term memory. I've found that the LSTM is unable to tie together longer-term dependancies well, e.g., this is especially evident in levels where a key is located very far away from the door it opens.
